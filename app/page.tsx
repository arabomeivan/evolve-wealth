...
{/* First Section */}
  <div className=" grid md:grid-cols-2 space-y-10 md:space-y-0">
      ...
      Get Rich in <span className="text-primary">Trading</span> <span className="text-primary">Claim</span> Your Spot Now
      </h2>

      <p className="text-grey pb-5">Discover How to Make a Fortune in Trading with Our Exclusive Education Program!</p>
...
<div className="mb-32">
  ...
  />
  <p className="text-white font-bold mb-2">Expert Traders as Your Coaches </p>
  <p className="text-white">Briefly introduce the expert traders and their track record of success. </p>
</div>
...
<div>
  ...
  <p className="text-white">Only 250 usd to start trading and earning money.</p>
</div>
</div>
...
<div className="mb-32">
  ...
  <p className="text-white">Emphasise the proven strategies taught in the program.</p>
</div>
...
<div>
  ...
  className="mb-5 block mx-auto"
  />
  <p className="text-white font-bold mb-2">Assistant with ricking regulated and safe trading platform.</p>
</div>
</div>
...
<div className="mb-20">
  ...
  <p className="text-white">Crypto trading expert coaches will provide you with dedicated signals to catch all the “inside information” based on fundamentals analysis and financial forecasts.</p>
</div>
...
<div>
  ...
  <p className="text-white font-bold mb-2">Offer a money-back guarantee for the program.</p>
</div>
</div>
  </div>
</div>
...
<p className="text-grey mb-10 md:text-xl">CEO Evolve Wealth Group</p>
...
<p className="font-bold mb-5">
  <span className="text-white">Referral Bonus</span>: {pricing.referral_bonus}
</p>
...
There are over 100,000 crypto millionaires out there, take your opportunity now to join them!
</p>
</div>
<div className="box_2">
  <div className="rounded-[20px] text-center p-5 md:p-10 md:max-w[556px] shadow-lg">
<p className="mb-10">
<span className="text-purple font-bold max-w-[334px]">Discover your potential 
income in the short term</span> 
...
<div className="flex justify-center mx-auto md:max-w-[438px] box_3">
  ...
  Invest and start making 
money <span className="text-[#FA923C]">now!</span>
  </p>
</div>
